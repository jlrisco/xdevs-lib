...
public class Coordinator extends AbstractSimulator implements CoordinatorInterface {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6792818248045455887L;

	private static final Logger logger = Logger.getLogger(Coordinator.class
            .getName());

	public CoupledInterface model;
	public LinkedList<SimulatorInterface> simulators = new LinkedList<>();
