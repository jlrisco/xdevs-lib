...
public class MDCosim2 extends Atomic{
    ...
    public MDCosim2(String name, double delay){
        super(name);
        super.addOutPort(oS2);
        super.addInPort(iB2);
        super.addInPort(iA2);
        super.addOutPort(oS1);
        super.addInPort(iA1);
        super.addInPort(iB1);
        super.addOutPort(oUD);
        super.addOutPort(oS3);
        super.addInPort(iA3);
        super.addInPort(iB3);
        this.delay = delay;
    ...
    public MDCosim2(double delay) {
        this(MDCosim1.class.getName(), delay);
    }

    public MDCosim2(String name) {
        this(name, ADDER_DELAY + 2*NOTS_DELAY);
    }
    ...
    public void lambda() {
        if(super.phaseIs("active")){
            ...
            mask = 1 << 2;
            valueToS3 = (floor & mask) != 0 ? 1 : 0;
            mask = 1 << 1;
            valueToS2 = (floor & mask) != 0 ? 1 : 0;
            mask = 1;
            valueToS1 = (floor & mask) != 0 ? 1 : 0;
        }
        this.oS2.addValue(this.valueToS2);
        this.oUD.addValue(this.valueToUD);
        this.oS3.addValue(this.valueToS3);
        this.oS1.addValue(this.valueToS1);
    }
