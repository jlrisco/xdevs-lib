 ...
 */
public class RPiP2 extends Coupled{
    public RPiP2(String name, String stimulusFilePath) {
        ...
        // Adder and NOT gates
        MDCosim2 chipExt = new MDCosim2("BD");
        ...
        super.addCoupling(chipExt.oS3, chipC.iPin3);
        super.addCoupling(chipExt.oS2, chipC.iPin4);
        super.addCoupling(chipExt.oS1, chipC.iPin5);
        // ChipC
    ...
    public static void main(String[] args) {
        ...
        RPiP2 rasp = new RPiP2("Raspberry", "." + File.separator + "lib" + File.separator + "test1.txt");
